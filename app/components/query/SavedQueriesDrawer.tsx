        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3">
          {savedQueries.map((sq) => {
            ...
            return (
              <div
                key={sq.id}
                className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200/80 dark:border-slate-700/80 hover:border-indigo-300 dark:hover:border-indigo-700 transition-all space-y-2"
              >
                {/* Title row */}
                  ...
                  {isEditing ? (
                    <div className="flex items-center gap-2 flex-1">
                      <input
                        ...
                        className="px-2 py-1 text-xs font-bold bg-white dark:bg-slate-900 border border-indigo-500 rounded text-slate-900 dark:text-slate-100 focus:outline-none flex-1"
                        autoFocus
                      />
                      <button
